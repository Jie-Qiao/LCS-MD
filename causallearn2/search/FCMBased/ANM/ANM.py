...
class ANM(object):
    '''
    Python implementation of additive missingness model-based causal discovery.
    References
    ----------
    [1] Hoyer, Patrik O., et al. "Nonlinear causal discovery with additive missingness models." NIPS. Vol. 21. 2008.
    '''
    ...
    def __init__(self, kernelX='Gaussian', kernelY='Gaussian'):
        ...
        kernelY: kernel function for estimated missingness
        '''
    ...
    def cause_or_effect(self, data_x, data_y):
        '''
        Fit a GP model in two directions and test the independence between the input and estimated missingness
