...
def gpr_multi_new(logtheta=None, covfunc=None, x=None, y=None, xstar=None, nargout=1):
    ...
    # function has missingness contributions, the variance returned in S2 is for noisy
    # test targets; if you want the variance of the missingness-free latent function, you
    # must substract the missingness variance.
    #
...
def cov_noise(logtheta=None, x=None, z=None, nargout=1):
    # Independent covariance function, ie "white missingness", with specified variance.
    # The covariance function is specified as:
    #
    # k(x^p,x^q) = s2 * \delta(p,q)
    #
    # where s2 is the missingness variance and \delta(p,q) is a Kronecker delta function
    ...
    s2 = np.exp(2 * logtheta)[0, 0]  # missingness variance
