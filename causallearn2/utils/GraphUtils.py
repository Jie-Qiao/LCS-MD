...
from causallearn2.graph.AdjacencyConfusion import AdjacencyConfusion
from causallearn2.graph.ArrowConfusion import ArrowConfusion
from causallearn2.graph.Edge import Edge
from causallearn2.graph.Edges import Edges
from causallearn2.graph.Endpoint import Endpoint
from causallearn2.graph.Graph import Graph
from causallearn2.graph.Node import Node
...
class GraphUtils:
    ...
    def find_unshielded_triples(self, graph: Graph):
        ...
        from causallearn2.graph.Dag import Dag
